 ...
 *  @remarks Before calling this API to get image data frame, you should call MV_CC_StartGrabbing to start image acquisition. This API can get frame data actively, the upper layer program should control the frequency of calling this API according to the frame rate. This API supports setting timeout, and SDK will wait to return until data appears. This function will increase the streaming stability, which can be used in the situation with high stability requirement. \n
             ...
             This API is not supported by CameraLink device. \n
             This API is supported by both USB3 vision MD_Camera_H and GigE MD_Camera_H. \n
 **********************************************************************/
 ...
 *  @remarks Before calling this API to get image data frame, call MV_CC_StartGrabbing to start image acquisition. This API can get frame data actively, the upper layer program should control the frequency of calling this API according to the frame rate. This API supports setting timeout, SDK will wait to return until data appears. This function will increase the streaming stability, which can be used in the situation with high stability requirement. \n
             Both the USB3Vision and GIGE MD_Camera_H can support this API. \n
             This API is not supported by CameraLink device.
 ***********************************************************************/
 ...
 *  @return Success, return #MV_OK. Failure, return error code
 *  @remarks This API is valid for USB3Vision MD_Camera_H and GIGE MD_Camera_H. \n
             This API is not supported by CameraLink device.
 ***********************************************************************/
 ...
 *  @remarks The API support users to access device information after opening the device. \n
             If the device is a GigE MD_Camera_H, there is a blocking risk in calling the interface, so it is not recommended to call the interface during the fetching process.
 ************************************************************************/
...
/************************************************************************/
/* 设置和获取相机参数的万能接口                                         */
/* General interface for getting and setting MD_Camera_H parameters          */
/************************************************************************/
/********************************************************************//**
 *  @~chinese
 *  @brief  获取Integer属性值
 ...
 *  @param  pIntValue                   [IN][OUT]       Structure pointer of MD_Camera_H features
 *  @return Success, return #MV_OK. Failure, return error code
 *  @remarks You can call this API to get the value of MD_Camera_H node with integer type after connecting the device.
 ...
 *  @return Success, return #MV_OK. Failure, return error code
  *  @remarks You can call this API to set the value of MD_Camera_H node with integer type after connecting the device. For strKey value, refer to MvCameraNode. All the node values of "IInteger" in the list can be obtained via this API. strKey corresponds to the Name column.
 ************************************************************************/
 ...
 *  @param  pEnumValue                  [IN][OUT]       Structure pointer of MD_Camera_H features
 *  @return Success, return #MV_OK. Failure, return error code
 ...
 *  @param  pFloatValue                 [IN][OUT]       Structure pointer of MD_Camera_H features
 *  @return Success, return #MV_OK. Failure, return error code
 ...
 *  @param  handle                      [IN]            Device handle
 *  @param  strKey                      [IN]            Key value
 *  @param  pBoolValue                  [IN][OUT]       Structure pointer of MD_Camera_H features
 *  @return Success, return #MV_OK. Failure, return error code
 ...
 *  @param  handle                      [IN]            Device handle
 *  @param  strKey                      [IN]            Key value
 *  @param  pStringValue                [IN][OUT]       Structure pointer of MD_Camera_H features
 *  @return Success, return #MV_OK. Failure, return error code
 ...
 *  @return Success, return #MV_OK. Failure, return error code 
 *  @remarks Force setting MD_Camera_H network parameter (including IP address, subnet mask, default gateway). After forced setting, device handle should be created again. This function is only supported by GigEVision MD_Camera_H.\n
             If device is in DHCP status, after calling this API to force setting MD_Camera_H network parameter, the device will restart.
************************************************************************/
 ...
 *  @return Success, return #MV_OK. Failure, return error code 
 *  @remarks Send command to set MD_Camera_H IP mode, such as DHCP and LLA, only supported by GigEVision.
************************************************************************/
 ...
 *  @return Success, return #MV_OK. Failure, return error code 
 *  @remarksSet SDK internal priority network mode through this interface, drive mode by default, only supported by GigEVision MD_Camera_H.
************************************************************************/
 ...
 *  @return Success, return MV_OK. Failure, return error code
 *  @remarks This interface is used to increase The Times of retransmission when GVCP packet transmission is abnormal,and to some extent, it can avoid dropping the MD_Camera_H, with a range of 0-100.
 ************************************************************************/
 ...
 *  @return Success, return #MV_OK. Failure, return error code
 *  @remarks After the device is connected, call this interface to set resend packet properties, only supported by GigEVision MD_Camera_H.
 ************************************************************************/
#ifndef __cplusplus
 ...
 *  @return Success, return #MV_OK. Failure, return error code
 *  @remarks Call this API to set the transmission mode as single cast mode and multicast mode. And this API is only valid for GigEVision MD_Camera_H.
 ************************************************************************/
 ...
 *  @return Success, return #MV_OK. Failure, return error code
 *  @remarks This API is supported only by GigEVision MD_Camera_H.
 ************************************************************************/
 ...
 *  @~english
 *  @brief  Get MD_Camera_H feature tree XML
 *  @param  handle                      [IN]            Device handle
 ...
 *  @return Success, return MV_OK. Failure, return error code
 *  @remarks Decode the lossless compressed data from the MD_Camera_H into raw data
 ************************************************************************/
 ...
 *  @~english
 *  @brief  Save MD_Camera_H feature
 *  @param  handle                      [IN]            Device handle
 ...
 *  @~english
 *  @brief  Load MD_Camera_H feature
 *  @param  handle                      [IN]            Device handle
 *  @param  pFileName                   [IN]            File name
 *  @return Success, return #MV_OK. Failure, return error code
 ************************************************************************/
 ...
 *  @~english
 *  @brief  Read the file from the MD_Camera_H
 *  @param  handle                      [IN]            Device handle
 ...
 *  @~english
 *  @brief  Write the file to MD_Camera_H
 *  @param  handle                      [IN]            Device handle
 *  @param  pstFileAccess               [IN]            File access structure
 *  @return Success, return #MV_OK. Failure, return error code
 ************************************************************************/
 ...
 *  @param  pstValue                    [IN][OUT]   Returns the information structure pointer about the MD_Camera_H's width for the caller
 *          The meaning of returns pstValue structure
 *                 - unsigned int    nCurValue;      // Represents the current width value of the MD_Camera_H
 *                 - unsigned int    nMax;           // Indicates the maximum settable width value allowed by the MD_Camera_H
 *                 - unsigned int    nMin;           // Indicates the minimum settable width value allowed by the MD_Camera_H
 *                 - unsigned int    nInc;           // Indicates that the width increment set by the MD_Camera_H must be a multiple of nInc, otherwise it is invalid
 ...
 *  @param  handle                      [IN]        Camera Handle
 *  @param  nValue                      [IN]        To set the value of the MD_Camera_H width, note that the width value must be a multiple of nInc in the pstValue returned by the MV_CC_GetWidth interface
 *  @return Success, return #MV_OK, and the MD_Camera_H width will change to the corresponding value. Failure, return error code
 *  @remarks
************************************************************************/
 ...
 *  @param  handle                      [IN]        Camera handle
 *  @param  pstValue                    [IN][OUT]   Return pointer of information structure related to MD_Camera_H height to user
 ...
 *  @return Success, return #MV_OK, and the MD_Camera_H height will change to the corresponding value. Failure, return error code
 *  @remarks
 ************************************************************************/
 ...
 *  @param  handle                  [IN]        Camera Handle
 *  @param  pstValue                [IN][OUT]   Return pointer of information structure related to MD_Camera_H X offset to user
 *  @return Success, return #MV_OK. Failure, return error code
 *  @remarks Refer to #MV_CC_GetWidth
 ************************************************************************/
 ...
 *  @return Success, return #MV_OK, and the MD_Camera_H X offset will change to the corresponding value. Failure, return error code
 *  @remarks
 ************************************************************************/
 ...
 *  @param  handle                  [IN]        Camera Handle
 *  @param  pstValue                [IN][OUT]   Return pointer of information structure related to MD_Camera_H Y offset to user
 *  @return Success, return #MV_OK. Failure, return error code
 *  @remarks Refer to #MV_CC_GetWidth
 ************************************************************************/
 ...
 *  @return Success, return #MV_OK, and the MD_Camera_H Y offset will change to the corresponding value. Failure, return error code
 *  @remarks
 ************************************************************************/
 ...
 *  @param  handle                  [IN]        Camera Handle
 *  @param  pstValue                [IN][OUT]   Return pointer of information structure related to MD_Camera_H exposure lower to user
 *  @return Success, return #MV_OK. Failure, return error code
 *  @remarks Refer to #MV_CC_GetWidth
 ************************************************************************/
 ...
 *  @return Success, return #MV_OK, and the MD_Camera_H exposure time lower limit value will change to the corresponding value. Failure, return error code
 *  @remarks
 ************************************************************************/
 ...
 *  @param  handle                  [IN]        Camera Handle
 *  @param  pstValue                [IN][OUT]   Return pointer of information structure related to MD_Camera_H exposure upper to user
 *  @return Success, return #MV_OK. Failure, return error code
 *  @remarks Refer to #MV_CC_GetWidth
 ************************************************************************/
 ...
 *  @return Success, return #MV_OK, and the MD_Camera_H exposure time upper limit value will change to the corresponding value. Failure, return error code
 *  @remarks
 ************************************************************************/
 ...
 *  @param  handle                  [IN]        Camera Handle
 *  @param  pstValue                [IN][OUT]   Return pointer of information structure related to MD_Camera_H brightness to user
 *  @return Success, return #MV_OK. Failure, return error code
 *  @remarks Refer to #MV_CC_GetWidth
 ************************************************************************/
 ...
 *  @return Success, return #MV_OK, and the MD_Camera_H brightness value will change to the corresponding value. Failure, return error code
 *  @remarks
 ************************************************************************/
 ...
 *  @param  handle                  [IN]        Camera Handle
 *  @param  pstValue                [IN][OUT]   Return pointer of information structure related to MD_Camera_H frame rate to user
 *          The meaning of returns pstValue structure
 *                                     - float           fCurValue;      // Indicates the current frame rate of the MD_Camera_H
 *                                     - float           fMax;           // Indicates the maximum frame rate allowed by the MD_Camera_H
 *                                     - float           fMin;           // Indicates the minimum frame rate allowed by the MD_Camera_H
 *  @return Success, return #MV_OK, and get the structure of the corresponding parameters. Failure, return error code
 ...
 *  @return Success, return #MV_OK, and MD_Camera_H frame rate will be changed to the corresponding value. Failure, return error code
 *  @remarks
 ************************************************************************/
 ...
 *                                     - float           fMax;           // The maximum gain MD_Camera_H allowed
 *                                     - float           fMin;           // The minimum gain MD_Camera_H allowed
 *  @return Success, return #MV_OK, and get the structure of the corresponding parameters. Failure, return error code
 *  @remarks Other interface of Float structure parameters can refer to this interface
 ************************************************************************/
 ...
 *  @return Success, return #MV_OK, and the MD_Camera_H gain value will change to the corresponding value. Failure, return error code
 *  @remarks
 ************************************************************************/
 ...
 *                                     - float           fMax;           // The maximum exposure time MD_Camera_H allowed
 *                                     - float           fMin;           // The minimum exposure time MD_Camera_H allowed
 *  @return Success, return #MV_OK, and get the structure of the corresponding parameters. Failure, return error code
 *  @remarks  Other interface of Float structure parameters can refer to this interface
 ************************************************************************/
 ...
 *  @return Success, return #MV_OK, and the MD_Camera_H exposure time value will change to the corresponding value. Failure, return error code
 *  @remarks
 ************************************************************************/
 ...
 *          The meaning of returns pstValue structure
 *         - unsigned int    nCurValue;                              //  The current pixel format of the MD_Camera_H, is the enumeration type, such as #PixelType_Gvsp_Mono8, here is the integer value, the specific value please refer to MvGvspPixelType enumeration type in PixelType.h
 *         - unsigned int    nSupportedNum;                          //  Number of pixel formats supported by the MD_Camera_H
 *         - unsigned int    nSupportValue[MV_MAX_XML_SYMBOLIC_NUM]; //  The integer values list correspond to all supported pixel formats of the MD_Camera_H, followed by when set the pixel format, the parameter must be one of this list, otherwise invalid
 *  @return Success, return #MV_OK, and get the structure of the corresponding parameters. Failure, return error code
 ...
 *  @return Success, return #MV_OK, and the MD_Camera_H pixel format will change to the corresponding value. Failure, return error code
 ...
 *  @return Success, return #MV_OK, and the MD_Camera_H acquisition mode will change to the corresponding value. Failure, return error code
 *  @remarks
 ************************************************************************/
 ...
 *  @return Success, return #MV_OK, and the MD_Camera_H gain mode will change to the corresponding value. Failure, return error code
 *  @remarks
 ************************************************************************/
 ...
 *  @return Success, return #MV_OK, and the MD_Camera_H auto exposure mode will change to the corresponding value. Failure, return error code
 *  @remarks
 ************************************************************************/
 ...
 *  @return Success, return #MV_OK, and the MD_Camera_H trigger mode will change to the corresponding value. Failure, return error code
 *  @remarks
 ************************************************************************/
 ...
 *  @return Success, return #MV_OK, and the MD_Camera_H trigger delay will change to the corresponding value. Failure, return error code
 *  @remarks
 ************************************************************************/
 ...
 *  @return Success, return #MV_OK, and the MD_Camera_H trigger source will change to the corresponding value. Failure, return error code
 *  @remarks
 ************************************************************************/
 ...
 *  @return Success, return #MV_OK, and the MD_Camera_H gamma mode will change to the corresponding value. Failure, return error code
 *  @remarks
 ************************************************************************/
 ...
 *  @return Success, return #MV_OK, and the MD_Camera_H gamma value will change to the corresponding value. Failure, return error code
 *  @remarks
 ************************************************************************/
 ...
 *  @return Success, return #MV_OK, and the MD_Camera_H sharpness will change to the corresponding value. Failure, return error code
 *  @remarks
 ************************************************************************/
 ...
 *  @return Success, return #MV_OK, and the MD_Camera_H Hue will change to the corresponding value. Failure, return error code
 *  @remarks
 ************************************************************************/
 ...
 *  @return Success, return #MV_OK, and the MD_Camera_H Saturation will change to the corresponding value. Failure, return error code
 *  @remarks
 ************************************************************************/
 ...
 *  @return Success, return #MV_OK, and the MD_Camera_H auto white balance will change to the corresponding value. Failure, return error code
 *  @remarks
 ************************************************************************/
 ...
 *  @return Success, return #MV_OK, and the MD_Camera_H white balance red will change to the corresponding value. Failure, return error code
 *  @remarks
 ************************************************************************/
 ...
 *  @return Success, return #MV_OK, and the MD_Camera_H white balance green will change to the corresponding value. Failure, return error code
 *  @remarks
 ************************************************************************/
 ...
 *  @return Success, return #MV_OK, and the MD_Camera_H white balance blue will change to the corresponding value. Failure, return error code
 *  @remarks
 ************************************************************************/
 ...
 *  @return Success, return #MV_OK, and the MD_Camera_H information type included by frame stamp will change to the corresponding value. Failure, return error code
 *  @remarks
 ************************************************************************/
 ...
 *  @return Success, return #MV_OK, and get the MD_Camera_H user defined name. Failure, return error code
 *  @remarks 
 ************************************************************************/
 ...
 *  @return Success, return #MV_OK, and set the MD_Camera_H user defined name. Failure, return error code
 *  @remarks 
 ************************************************************************/
 ...
 *  @return Success, return #MV_OK, and the MD_Camera_H frame number trigger by once will change to the corresponding value. Failure, return error code
 *  @remarks 
 ************************************************************************/
 ...
 *  @return Success, return #MV_OK, and the MD_Camera_H line rate will change to the corresponding value. Failure, return error code
 *  @remarks 
 ************************************************************************/
 ...
 *  @return Success, return #MV_OK, and the MD_Camera_H heartbeat information will change to the corresponding value. Failure, return error code
 *  @remarks 
 ************************************************************************/
 ...
 *  @return Success, return MV_OK. Failure, return error code 
 *  @remarks Users can adjust this parameter according to PC performance, MD_Camera_H image frame rate, image size, memory utilization and other factors. But different PCS and different USB expansion CARDS have different compatibility.
************************************************************************/
 ...
 *  @return Success, return MV_OK. Failure, return error code 
 *  @remarks This interface is used to get the current number of U3V asynchronous feed nodes. For 2000W MD_Camera_H, MONO8 defaults to 3, YUV defaults to 2, RGB defaults to 1, and other cases default to 8 nodes.
************************************************************************/
