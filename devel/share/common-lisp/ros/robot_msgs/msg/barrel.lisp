...
(cl:defmethod cl:initialize-instance :after ((m <barrel>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'barrel)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_msgs-msg:<barrel> is deprecated: use robot_msgs-msg:barrel instead.")))
...
(cl:defmethod num-val ((m <barrel>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_msgs-msg:num-val is deprecated.  Use robot_msgs-msg:num instead.")
  (num m))
...
(cl:defmethod grade-val ((m <barrel>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_msgs-msg:grade-val is deprecated.  Use robot_msgs-msg:grade instead.")
  (grade m))
