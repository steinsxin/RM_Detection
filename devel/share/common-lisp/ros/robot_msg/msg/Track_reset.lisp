...
(cl:defmethod cl:initialize-instance :after ((m <Track_reset>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Track_reset)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_msg-msg:<Track_reset> is deprecated: use robot_msg-msg:Track_reset instead.")))
...
(cl:defmethod Reset-val ((m <Track_reset>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_msg-msg:Reset-val is deprecated.  Use robot_msg-msg:Reset instead.")
  (Reset m))
