...
(cl:defmethod cl:initialize-instance :after ((m <PTZ_perception>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PTZ_perception)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_msg-msg:<PTZ_perception> is deprecated: use robot_msg-msg:PTZ_perception instead.")))
